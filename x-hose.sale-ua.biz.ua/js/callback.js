$(document).ready(function(){
	...
	$('#cbh_phone_input').mask("+38 (999) 999-99-99");
	$('#cbh_phone_input_deferred').mask("+38 (999) 999-99-99");
	$('#cbh_item_dialog_input_2').mask("+38 (999) 999-99-99");
	...
	$('.cbh-widget-content').click(function(){
		...
		$('#cbh_container').height(window.innerHeight);
...
function setDate(){
	...
	if(day == 6){
		requireDate.setDate(requireDate.getDate() + 2); 
	}
	
	if(day != 0 && day != 6 && time < 9 && time >= 20){
		requireDate.setDate(requireDate.getDate()); 
	}else if(day != 0 && day != 6 && time > 20){
		requireDate.setDate(requireDate.getDate()+1); 
	}
